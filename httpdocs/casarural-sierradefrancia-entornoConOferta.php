...
<script type="text/javascript">
function openDialog(pagina) {
var opciones="toolbar=no,location=no,directories=no,status=no,menubar=no,scrollbars=no,resizable=yes,width=600,height=600,top=100,left=300";
    ...
    <tr>
     <td height="52" align="center" style="background-image: url(images/htop.jpg?template=personal-018&colorScheme=green&header=&button=buttons1); background-repeat: no-repeat; background-position: right bottom; padding-right: 30px; padding-left: 30px;">
       <table border="0" cellspacing="0" cellpadding="0">
        <tr>
         <td align="center">
          <a href="casarural-sierradefrancia-entorno.php" class="amenu" lang="es">Entorno</a>
         </td>
...
<p align="justify" style="margin-right: 0px" dir="ltr"><span style="font-size: medium;"><span style="font-family: Arial;" lang="es"><strong lang="es">Casa Salva, turismo rural</strong></span></span></p>
<p>
<div class="container">
        <p class="lineheight">
            <a class="initialism basic_open btn btn-success" href="#basic">¡Estas Navidades Casa Rural Casa Salva y Ver Aves ofrecen un fin de semana con  Ruta ornitológica y Taller creativo (reservas hasta el 31 de enero de 2017)!</a>
        </p>     
</div>
<!-- Basic -->
<div id="basic" class="well" style="max-width:44em;">
    <h3>Casa Salva y Ver Aves ofrecen un fin de semana con  Ruta ornitológica y Taller creativo </h3>
    <!--<h4>En la casa rural Casa Salva ruta de observación e identificación de aves y taller de escultura de aves</h4>-->
    <p align="middle"><img src="/images/Ruta-y-Taller-Rinconada.jpg" alt="Ver Aves en Casa Salva" width="350" heigth="287" align="middle"></p>
<p><strong>Ruta de observación e identificación de aves.</strong>  Saldremos a pasear por el bello entorno de La Rinconada de la Sierra, a pie de la Sierra de las Quilamas y dentro de la Reserva de la Biosfera de la Sierra de Francia. Haremos una ruta ornitológica guiada, acompañado por guía profesional, usando telescopio, prismáticos y guías de aves. Apto para adultos y niños mayores de 8 años.   
<br>
3-4h por la mañana.  
<br>
<strong>Precio Casa rural + ruta 400€ </strong>
</p>
<p>
<strong>Taller creativo Volar con Arte.</strong> Taller de escultura de aves utilizando papel y cartón reciclado y engrudo casero. Crearemos pequeñas esculturas de algunas  aves de nuestro entorno, como la Cigüeña, la Golondrina o el Petirrojo, aprendiendo la técnica de modelar con engrudo y materiales  reciclados para reproducir las formas y los colores de las aves a través de la creatividad. En dos sesiones podremos darles forma y pintar nuestras creaciones.   
<br>
Apto para adultos y niños mayores de 5 años. 
<br>
<strong>Precio Casa rural + taller 480€  Precio Casa rural +ruta + taller en la misma estancia 580€ </strong>
</p>
<p>
*Promoción limitada: suejeta a la disponibilidad de la actividad en el momento de hacer la reserva para tus estancias hasta el 31 de enero de 2017.</p>
    <p>La actividad incluye:
<ul>
<li type="circle">Alojamiento hasta 8 personas.</li>
<li type="circle">Cesto de leña para la chimenea y la barbacoa.</li>
</ul>
</p>
   <p>Ideal para:
<ul>
<li type="circle">Grupos de amigos.</li>
<li type="circle">Familias con niños.</li>
</ul>
</p>
    <button class="basic_close btn btn-default" align="middle">Cerrar</button>
</div>
<script>
...
<img src="/gallery_images/casa-rural-casa-salva-08-sanvalentin-enamorados-parejas_resized_1800.jpg" alt="Jamón, vino y pan de pueblo en la terraza. Ideal para enamorarte." width="350" heigth="287" align="middle"></p>
...
<td align="center">
<a href="casarural-sierradefrancia-entorno.php" class="abmenu" id="abmenu1"  lang="es">Entorno</a>
</td>
<td>
