...
<BODY MARGINHEIGHT="0" MARGINWIDTH="0" TOPMARGIN="0" RIGHTMARGIN="0" BOTTOMMARGIN="0" LEFTMARGIN="0" onload="openDialog('http://www.casasalva.es/oferta.html')"">
...
<div class="container">
        <p class="lineheight">
            <a class="initialism basic_open btn btn-success" href="#basic">Oferta del 25% en el mes de las flores</a>
        </p>     
</div>
<!-- Basic -->
<div id="basic" class="well" style="max-width:44em;">
    <h3>¡Mayo en una casa rural de la Sierra de Francia con amigos o en familia!</h3>
    <h4>Del 06-08 de Mayo (2 noches) paga sólo 180 €, antes 240 € (25% de descuento).</h4>
    <p align="middle"><img src="/gallery_images/casa-rural-casa-salva-granja-cordero-niño-sonriente.jpg" alt="Oferta en casa rural en la Sierra de Francia en mayo" width="350" heigth="287" align="middle"></p>
<p>Mes de las flores con oferta rural. <strong>Casa rural en la Sierra de Francia</strong>. Salón con <strong>chimenea</strong>, cuatro habitaciones con decoración rústica, <strong>jardín con columpios, arenero, parque infantil y minigolf para los niños</strong>, barbacoa y bodega para los mayores. Visitas a la <strong>granja de animales</strong>, practicar senderismo, zona de aprovechamiento de setas o rutas a caballo. Cuarto de baño con bañera de hidromasaje. Visitas a <strong>La Alberca, Mogarraz y Candelario</strong>.</p>
    <p>La oferta incluye:
<ul>
<li type="circle">Alojamiento para 8 personas.</li>
